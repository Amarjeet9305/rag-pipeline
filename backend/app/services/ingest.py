...
#     1. Save to uploads directory
#     2. Extract text
#     3. Chunk text
#     4. Generate embeddings
#     5. Store embeddings in Chroma/FAISS
#     6. Save document and chunk metadata in MongoDB
#     """
...
#         log(f"Failed to save file {filename}: {e}")
#         return {"error": f"Failed to save file {filename}: {e}"}
...
#     try:
#         insert_document_metadata(filename, filepath, len(chunks), file_size, doc_id)
#         for c in chunk_data:
